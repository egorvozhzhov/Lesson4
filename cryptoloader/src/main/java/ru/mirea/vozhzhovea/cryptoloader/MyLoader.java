...
public class MyLoader extends AsyncTaskLoader<String> { private String decrMess;
    ...
    public MyLoader(@NonNull Context context, Bundle args)
    {
        ...
        if (args != null)
        {
            ...
            //args.putString(ARG_WORD,firstName);
        }
    ...
    @Override
    public String loadInBackground() { // emulate long-running operation
